...
import { HEADER_THEMES, SUPPORTED_ICON_TOKENS, TAG_COLORS, } from "./snapshot.js";
...
export const componentSpecSchema = z.lazy(() => z.discriminatedUnion("kind", [
    z.strictObject({
...
export const blockSpecSchema = z.strictObject({
...
export const cardSpecSchema = z.strictObject({
    ...
    config: z
        ...
        streamingConfig: z
            ...
            .optional(),
        textStyles: z
            .record(identifierSchema, z.strictObject({
...
export function cardSpecJsonSchema() {
