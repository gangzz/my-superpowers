...
export interface ButtonSpec extends BaseComponentSpec {
    kind: "button";
    text: string;
    appearance?: "default" | "primary" | "danger" | "text" | "primaryText" | "dangerText" | "primaryFilled" | "dangerFilled" | "laser";
...
export type TableDataType = "text" | "larkMd" | "number" | "options" | "persons" | "date" | "markdown";
...
export type ComponentSpec = MarkdownSpec | DivSpec | HrSpec | ImageSpec | ButtonSpec | InputSpec | StaticSelectSpec | FormSpec | TableSpec | ColumnSpec | ColumnSetSpec | CollapsiblePanelSpec | InteractiveContainerSpec;
...
export interface HeaderSpec {
    title: TextSpec;
    subtitle?: TextSpec;
    theme?: "blue" | "wathet" | "turquoise" | "green" | "yellow" | "orange" | "red" | "carmine" | "violet" | "purple" | "indigo" | "grey" | "default";
    tags?: HeaderTagSpec[];
    icon?: IconSpec;
    padding?: string;
}
